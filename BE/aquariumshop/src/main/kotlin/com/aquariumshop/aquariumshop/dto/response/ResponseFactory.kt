...
object ResponseFactory {
    ...
    fun badRequest(message: String = "Bad request"): ResponseEntity<APIResponse<Nothing>> {
        return ResponseEntity(
    ...
    fun unauthorized(message: String = "Unauthorized"): ResponseEntity<APIResponse<Nothing>> {
        return ResponseEntity(
    ...
    fun serverError(message: String = "Internal server error"): ResponseEntity<APIResponse<Nothing>> {
        return ResponseEntity(
