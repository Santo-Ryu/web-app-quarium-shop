...
class EncryptServiceImpl: EncryptService {
    ...
    data class TransformedKey(val newAESKey: SecretKey, val iv: ByteArray, val timeStr: String)
    ...
    private fun transformKey(aesKey: ByteArray, iv: ByteArray, timeStr: String): TransformedKey {
        ...
        val iterations = timeShift.coerceIn(1000, 10000) * 10
    ...
    override fun decrypt(encodedData: String): String {
        val encryptDataBase64 = encodedData.substring(0, 8) +
                encodedData.substring(84)
        val mixedPartsBase64 = encodedData.substring(8, 40) +
    ...
    data class ParsedParts(val aesKey: ByteArray, val ivCode: ByteArray)
